      ...
      <div class='site-wrapper-inner'>
        <div class='cover-container'>
          ...
          <div class='inner cover'>
            ...
            <a class='btn btn-lg btn-default' href='#'>Watch this space</a>
          </div>
          <div class='mastfoot'>
            <div class='mastfoot-inner'>
              <span class='bumf1'>
                Hosting by
                <a href='http://cloudatcost.com'>Cloudatcost.com</a>
              </span>
              <span class='boiler bumf2'>
                <?php echo 'Modified: '. date('Y-m-d') ."\n"; ?>
              </span>
            </div>
          </div>
        </div>
