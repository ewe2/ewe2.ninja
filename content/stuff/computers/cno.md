...
`$` is "AT&T syntax" for `#` in DEC assembler syntax, and is usually a PC instruction. Remember
...
I don't know if Harris disassembled the VAX version or the PDP11 version but that is amazingly
